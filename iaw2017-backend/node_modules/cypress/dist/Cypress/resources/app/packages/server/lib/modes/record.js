(function() {
  var Project, Promise, _, api, chalk, ciProvider, commitInfo, debug, errors, headless, logException, logger, os, stdout, terminal, upload;
  ...
  module.exports = {
    generateProjectBuildId: function(projectId, projectPath, projectName, recordKey, group, groupId) {
      if (!recordKey) {
      ...
      return commitInfo.commitInfo(projectPath).then(function(git) {
      ...
      return Project.add(projectPath).then(function() {
        ...
        return function(projectId) {
          ...
          return Project.config(projectPath).then(function(cfg) {
            ...
            return _this.generateProjectBuildId(projectId, projectPath, projectName, key, options.group, options.groupId).then(function(buildId) {
              if (!buildId) {
                return;
              }
