(function() {
  var Automation, EE, Project, Promise, Reporter, Server, Watchers, _, api, cache, commitInfo, config, cwd, debug, errors, fs, glob, ids, localCwd, log, logger, multipleForwardSlashesRe, path, savedState, scaffold, scaffoldLog, settings, user,
